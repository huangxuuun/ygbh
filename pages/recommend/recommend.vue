	...
	<view>
		...
		<scroll-view class="recommend-container" :scroll-y="true" @scrolltolower="lower">
			<swiper class="swiper" circular :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval"
				...
				indicator-active-color='linear-gradient(315deg, #8B3FFF 0%, #EF0EC9 100%)' :duration="duration">
				<swiper-item>
			...
			<view class="recommend-detail">
				<view class="recommend-detail__title">【8G】虎牙直播雅雅主播10套合集下载</view>
				...
				<view class="recommend-detail__line">
				</view>
